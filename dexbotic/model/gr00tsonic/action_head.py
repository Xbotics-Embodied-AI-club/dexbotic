...
#
# Ported from Isaac-GR00T (gr00t/model/gr00t_n1d7/gr00t_n1d7.py::Gr00tN1d7ActionHead)
# for GR00T N1.7 ("gr00tsonic") into Dexbotic. The flow-matching DiT action head is
# kept identical to the upstream implementation, including RTC (real-time chunking)
# inpainting support in get_action.
...
from dexbotic.model.gr00tsonic.modules.dit import (
    AlternateVLDiT,
    DiT,
    SelfAttentionTransformer,
)
from dexbotic.model.gr00tsonic.modules.embodiment_conditioned_mlp import (
    CategorySpecificMLP,
...
class Gr00tSonicActionHead(nn.Module):
